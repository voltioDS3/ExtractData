...
from analize_data import ChampionData, ChampionBuild
...
champ_maps = {
    ...
    11: ["MasterYi", "masteryi", "MASTERYI", 'yi', 'master', 'maestro yi', 'maestro'],
    ...
    142: ["Zoe", "zoe", "ZOE"],
    143: ["Zyra", "zyra", "ZYRA"],
    888: ['renata', 'rennata', 'renatta', 'rennatta', 'rena', 'renata glasc', 'renatta glasc', 'renatta glask'],
    200: ["bel'veth", 'belbeth', 'velbeth', 'velved', 'belveth', 'vel beth', 'bel veth'],
    895: ['nilah', 'nilaah', 'nila', 'nil'],
    'TOP': ['top', 'toplane'],
    'MIDDLE': ['mid', 'middle'],
